...
@section('content')
<div id="login-container" class="d-flex bg-info position-fixed h-100 w-100">
    ...
    <div class="w-50 d-flex flex-column justify-content-center align-items-center" style="margin-bottom: 100px">
        <div class="container">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        ...
                                        <a href="{{route('login')}}" class="text-info d-flex mt-2">
                                            {{ __('Or login here') }}
                                        </a>
                                    </div>
                                </div>
